        ...
        <div className="footerCard flex">
          <div className="footerIntro flex">
            ...
            <div data-aos="fade-up" className="footerParagraph">
              I'm baby banh mi franzen enamel pin grailed, microdosing you
              probably haven't heard of them typewriter. Ramps stumptown
              raclette, bespoke yuccie cray gentrify marxism vexillologist
              tattooed mlkshk migas lumbersexual.
            </div>
          ...
          <div className="footerDiv flex">
            ...
            <small>COPYRIGHTS RESERVED - IVAN KOVACEVIC 2023</small>
          </div>
        </div>
      </div>
    </section>
